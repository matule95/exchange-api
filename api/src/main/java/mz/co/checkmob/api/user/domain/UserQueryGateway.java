...
import static mz.co.checkmob.api.user.domain.query.UserSpecification.findByName;
import static mz.co.checkmob.api.user.domain.query.UserSpecification.findByUserName;
